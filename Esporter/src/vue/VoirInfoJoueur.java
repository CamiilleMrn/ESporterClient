...
import vue.component.EcurieInfoTeamRenderer;
import vue.component.VoirInfoPlayerRenderer;
...
public class VoirInfoJoueur extends DataJPanel {
	...
	private void initialize() {
		...
		btn_voirInfoTree.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				MasterFrame.getInstance().setPanel(vue.StableInfo.class, equipe.getStable());
			}
		});
